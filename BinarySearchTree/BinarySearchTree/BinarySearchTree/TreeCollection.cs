...
namespace BinarySearchTree
{
    ...
    public sealed class TreeCollection<T> : ICollection<T>
    {
        ...
        public TreeCollection(IComparer<T> comparer = null)
        {
            if (comparer is null)
            {
                if (Comparer<T>.Default is null)
                {
                    throw new ArgumentException($"{nameof(comparer)} is undefined");
                }
                else
                {
        ...
        /// <param name="comparer">Comparator.</param>
        public TreeCollection(T[] source, IComparer<T> comparer = null)
        {
            if (source is null)
            {
